...
def plot_history(history):
    ...
    history_df.to_csv(RESULT_DIR / "reports" / "efficientnetb0_history.csv", index=False)
    ...
    plt.legend()
    plt.savefig(RESULT_DIR / "graphs" / "efficientnetb0_accuracy.png")
    plt.close()
    ...
    plt.legend()
    plt.savefig(RESULT_DIR / "graphs" / "efficientnetb0_loss.png")
    plt.close()
...
def main():
    ...
    callbacks = [
        tf.keras.callbacks.ModelCheckpoint(
            filepath=MODEL_DIR / "efficientnetb0.keras",
    ...
    with open(RESULT_DIR / "reports" / "efficientnetb0_test_result.txt", "w", encoding="utf-8") as f:
